...
//           _buildMainSection(context, screenWidth, screenHeight)
//         ],
//       ),
//     );
//   }
...
//   }
//
//   Widget _buildMainSection(context, double screenWidth, double screenHeight) {
//     double buttonWidth = 0.9 * screenWidth;
                  ...
                  Navigator.of(context).push(
                    PageRouteBuilder(
                      pageBuilder: (context, animation, secondaryAnimation) => Collection(
                        database: CarsDatabase.instance, // Provide the database instance here
                      ),
                      transitionsBuilder: (context, animation, secondaryAnimation, child) {
                        const begin = Offset(1.0, 0.0);
                        const end = Offset.zero;
