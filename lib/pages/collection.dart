...
class Collection extends StatefulWidget {
  final CarsDatabase database;

  const Collection({Key? key, required this.database}) : super(key: key);
...
class _CollectionState extends State<Collection> {
  ...
  Future<void> refreshCars() async {
    carArray = await widget.database.readAllCars();
    await fillSvgCodeArray(); // Move filling svgCodeArray here
  }
